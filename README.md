Power_BI_Sales_Performance_Reports
...
1. Devlop a -[Sales Performance Report] to evalate Product-level Sales trands over Discount.()
2. Conduct a comprehensive comparison between[Sales trand over High level of Discount] and Discount increase sales but reduce Profit.()
3. Purpose of sales analytics: To enable organizations to track sales execution, monitor progress against Discount, and drive data-backed decision-making.
 4. Importance of analyzing sales data: Identify sales patterns and track key performance indicators (KPIs).
Role of reports: Determine effective sales performance, identify top Products, and make decision potential business expansion opportunities in countries.
